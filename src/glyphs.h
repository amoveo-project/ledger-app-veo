...
extern unsigned char const C_icon_dashboard_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_nanos_veo_badge_BPP
        #define GLYPH_nanos_veo_badge_WIDTH 16
        #define GLYPH_nanos_veo_badge_HEIGHT 16
        #define GLYPH_nanos_veo_badge_BPP 1
extern unsigned int const C_nanos_veo_badge_colors[];
extern unsigned char const C_nanos_veo_badge_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_nanos_veo_badge;
        #endif // GLYPH_nanos_veo_badge_BPP
        #endif // OS_IO_SEPROXYHAL
